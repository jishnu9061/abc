...
<body>
    <header role="banner">
        ...
        <ul class="utilities">
            ...
            <li class="logout warn"><a href="{{ url('login') }}">Log Out</a></li>
        </ul>
    </header>

    <nav role='navigation'>
        <ul class="main">
            <li class="dashboard" selected><a href="{{ url('home') }}">Home</a></li>
            <li class="edit"><a href="{{ url('deposit') }}">Deposit</a></li>
            <li class="write"><a href="{{ url('withdraw') }}">Withdraw</a></li>
            <li class="delete"><a href="{{ url('transfer') }}">Transfer</a></li>
