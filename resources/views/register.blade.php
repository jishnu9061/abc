...
<style>
    ...
    :root {
        ...
        /* comment this out to maintain vendor styling */
        ...
        --fh-layout-margin: 10px auto;
        /* change to "10px auto" to center */
...
<body>
    <div class="container">
        <form class="registration" method="post" action="{{ url('submitregistration') }}">
            @csrf
